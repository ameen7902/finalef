...
async def receive_pes_name(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(chat_id=-1002835703789, text=f"📢 Attention, players! @{user.username or user.first_name} has joined the roster, representing {team}. Let the games begin!"))
